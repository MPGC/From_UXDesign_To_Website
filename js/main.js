/*Code for the hamburger menu on small screens. The dropdown appears on click on the hamburger (invoking the OpenCloseNav function).
 Once shown I add the blocker div to complete the page and allow the user to click anywhere but the dropdown (including the X) to close it. */

 const headerSmall = document.getElementById('header__small');
 const menuLine = document.getElementsByClassName('menu__xs--lines')[0];
 const menuX = document.getElementsByClassName('menu__x')[0];
 const menuTitle = document.getElementsByClassName('menu__x--title')[0];
